# This file just initializes the SQLAlchemy db object and provides a helper function
# for transaction commitment and a base model with common transaction methods that
# our models can inherit
